...
# deny
execute @s[type=player,tag=paradoxOpped,scores={jesus=..0}] ~~~ scoreboard players set paradox:config jesus 1
execute @s[type=player,tag=paradoxOpped,scores={jesus=..0}] ~~~ tellraw @a[tag=paradoxOpped] {"rawtext":[{"text":"\n§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" has enabled §6Anti Jesus!"}]}

# allow
execute @s[type=player,tag=paradoxOpped,scores={jesus=1..}] ~~~ scoreboard players set paradox:config jesus 0
execute @s[type=player,tag=paradoxOpped,scores={jesus=1..}] ~~~ tellraw @a[tag=paradoxOpped] {"rawtext":[{"text":"\n§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" has disabled §4Anti Jesus!"}]}
