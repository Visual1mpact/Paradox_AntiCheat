...
# deny
execute @s[type=player,tag=paradoxOpped,scores={phase=..0}] ~~~ scoreboard players set paradox:config phase 1
execute @s[type=player,tag=paradoxOpped,scores={phase=..0}] ~~~ tellraw @a[tag=paradoxOpped] {"rawtext":[{"text":"\n§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" has enabled §6Anti Phase!"}]}

# allow
execute @s[type=player,tag=paradoxOpped,scores={phase=1..}] ~~~ scoreboard players set paradox:config phase 0
execute @s[type=player,tag=paradoxOpped,scores={phase=1..}] ~~~ tellraw @a[tag=paradoxOpped] {"rawtext":[{"text":"\n§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" has disabled §4Anti Phase!"}]}
