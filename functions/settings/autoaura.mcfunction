...
# deny
execute @s[type=player,tag=paradoxOpped,scores={autoaura=..0}] ~~~ scoreboard players set paradox:config autoaura 1
execute @s[type=player,tag=paradoxOpped,scores={autoaura=..0}] ~~~ tellraw @a[tag=paradoxOpped] {"rawtext":[{"text":"\n§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" has enabled §6Autoaura!"}]}

# allow
execute @s[type=player,tag=paradoxOpped,scores={autoaura=1..}] ~~~ scoreboard players set paradox:config autoaura 0
execute @s[type=player,tag=paradoxOpped,scores={autoaura=1..}] ~~~ tellraw @a[tag=paradoxOpped] {"rawtext":[{"text":"\n§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" has disabled §4Autoaura!"}]}
