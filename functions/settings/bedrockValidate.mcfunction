...
# allow
execute @s[type=player,tag=paradoxOpped,scores={bedrock=..0}] ~~~ scoreboard players set paradox:config bedrock 1
execute @s[type=player,tag=paradoxOpped,scores={bedrock=..0}] ~~~ tellraw @a[tag=paradoxOpped] {"rawtext":[{"text":"\n§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" has enabled §6BedrockValidate!"}]}

# deny
execute @s[type=player,tag=paradoxOpped,scores={bedrock=1..}] ~~~ scoreboard players set paradox:config bedrock 0
execute @s[type=player,tag=paradoxOpped,scores={bedrock=1..}] ~~~ tellraw @a[tag=paradoxOpped] {"rawtext":[{"text":"\n§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" has disabled §4BedrockValidate!"}]}
