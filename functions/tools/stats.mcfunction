...
execute @s[m=c] ~~~ tellraw @a[tag=notify] {"rawtext":[{"text":"§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" is in Creative Mode"}]}
...
tellraw @a[tag=notify,tag=debug] {"rawtext":[{"text":"§߈§r§4[§6Paradox§4]§r "},{"text":" ----- DEBUG STATS -----"}]}

execute @s[tag=ground] ~~~ tellraw @a[tag=notify,tag=debug] {"rawtext":[{"text":"§߈§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" onGround: §6true"}]}
