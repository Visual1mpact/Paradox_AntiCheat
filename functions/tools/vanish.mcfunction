...
tellraw @s[tag=novanish] {"rawtext":[{"text":"§4[§6Paradox§4] §rYou are no longer in vanish!"}]}
...
tellraw @s[tag=vanish,tag=!novanish] {"rawtext":[{"text":"§4[§6Paradox§4] §rYou are now in vanish!"}]}
