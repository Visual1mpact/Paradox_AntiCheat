...
tellraw @s[tag=nofreeze] {"rawtext":[{"text":"§r§4[§6Paradox§4] §r You are no longer frozen!"}]}
execute @s[type=player,tag=nofreeze] ~~~ detect ~~2~ barrier 0 setblock ~~2~ air
execute @s[tag=nofreeze] ~~~ tellraw @a[tag=op] {"rawtext":[{"text":"§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" is no longer frozen."}]}
...
execute @s[tag=freeze,tag=!nofreeze] ~~~ tellraw @a[tag=op] {"rawtext":[{"text":"§r§4[§6Paradox§4]§r "},{"selector":"@s"},{"text":" has been frozen"}]}
