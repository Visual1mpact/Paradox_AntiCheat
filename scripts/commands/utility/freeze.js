...
export function freeze(message, args) {
    ...
    if (member.hasTag('nofreeze')) {
        ...
        member.runCommand(`tellraw @a[tag=${crypto}] {"rawtext":[{"text":"§r§4[§6Paradox§4]§r ${disabler(member.nameTag)} is no longer frozen."}]}`);
    }
