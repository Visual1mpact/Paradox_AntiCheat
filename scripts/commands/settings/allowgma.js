...
export function allowgma(message) {
    ...
    if (!message) return console.warn(`${new Date()} | ` + "Error: ${message} isnt defined. Did you forget to pass it? (./commands/settings/allowGMA.js:12)");
    ...
    return Commands.run(`execute "${player.nameTag}" ~~~ function settings/allowGMA`, World.getDimension("overworld"));
}
