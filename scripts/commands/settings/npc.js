...
export function npc(message) {
    ...
    if (!message) return console.warn(`${new Date()} | ` + "Error: ${message} isnt defined. Did you forget to pass it? (./commands/settings/npc.js:12)");
    ...
    return Commands.run(`execute "${player.nameTag}" ~~~ function settings/npc`, World.getDimension("overworld"));
}
