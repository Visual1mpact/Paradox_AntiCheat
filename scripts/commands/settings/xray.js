...
export function xray(message) {
    ...
    if (!message) return console.warn(`${new Date()} | ` + "Error: ${message} isnt defined. Did you forget to pass it? (./commands/settings/xray.js:12)");
    ...
    return Commands.run(`execute "${player.nameTag}" ~~~ function settings/xray`, World.getDimension("overworld"));
}
