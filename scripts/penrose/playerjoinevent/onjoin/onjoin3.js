...
import { onJoinData3 } from "../../../data/onjoindata3.js";
...
// This function will be called when tick event is triggered from the onJoin3 function
function time() {
    try {
