...
function registry(data: WorldInitializeEvent) {
  ...
  if (worldborder_n === undefined) {
    World.setDynamicProperty(
      "worldborder_n",
      config.modules.worldBorder.overworld
    );
  }
  ...
  if (worldborderNether_n === undefined) {
    World.setDynamicProperty(
      ...
      config.modules.worldBorder.nether
    );
  }
  ...
  if (worldborder_b === undefined) {
    World.setDynamicProperty(
      "worldborder_b",
      config.modules.worldBorder.enabled
    );
  }
  ...
  if (antiteleport_b === undefined) {
    World.setDynamicProperty(
      "antiteleport_b",
      config.modules.antiTeleport.enabled
    );
  }
  ...
  if (illegalitemsa_b === undefined) {
    World.setDynamicProperty(
      "illegalitemsa_b",
      config.modules.illegalitemsA.enabled
    );
  }
  ...
  if (illegalitemsd_b === undefined) {
    World.setDynamicProperty(
      "illegalitemsd_b",
      config.modules.illegalitemsD.enabled
    );
  }
  ...
  if (adventuregm_b === undefined) {
    World.setDynamicProperty(
      "adventuregm_b",
      config.modules.adventureGM.enabled
    );
  }
  ...
  if (bedrockvalidate_b === undefined) {
    World.setDynamicProperty(
      "bedrockvalidate_b",
      config.modules.bedrockValidate.enabled
    );
  }
  ...
  if (antiscaffolda_b === undefined) {
    World.setDynamicProperty(
      "antiscaffolda_b",
      config.modules.antiscaffoldA.enabled
    );
  }
  ...
  if (illegalitemsc_b === undefined) {
    World.setDynamicProperty(
      "illegalitemsc_b",
      config.modules.illegalitemsC.enabled
    );
  }
  ...
  if (illegalitemsb_b === undefined) {
    World.setDynamicProperty(
      "illegalitemsb_b",
      config.modules.illegalitemsB.enabled
    );
  }
  ...
  if (illegallores_b === undefined) {
    World.setDynamicProperty(
      "illegallores_b",
      config.modules.illegalLores.enabled
    );
  }
  ...
  if (illegalenchantment_b === undefined) {
    World.setDynamicProperty(
      ...
      config.modules.illegalEnchantment.enabled
    );
  }
  ...
  if (antishulker_b === undefined) {
    World.setDynamicProperty(
      "antishulker_b",
      config.modules.antishulker.enabled
    );
  }
  ...
  if (badpackets2_b === undefined) {
    World.setDynamicProperty(
      "badpackets2_b",
      config.modules.badpackets2.enabled
    );
  }
