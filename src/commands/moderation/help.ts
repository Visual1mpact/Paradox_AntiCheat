...
export function help(message: ChatSendAfterEvent) {
    ...
    return sendMsgToPlayer(player, [
        ...
        `§6${prefix}unmute <username> <reason>§f - ${config.customcommands.unmute ? `Unmute the specified user.` : textDisabled}`,
        ...
        `§6${prefix}op <username>§f - ${config.customcommands.op ? `Op's player in Paradox AntiCheat features.` : textDisabled}`,
        `§6${prefix}deop <username>§f - ${config.customcommands.deop ? `Revokes Op player in Paradox AntiCheat features.` : textDisabled}`,
        `§6${prefix}modules§f - ${config.customcommands.modules ? `View all enabled or disabled modules.` : textDisabled}`,
        `§6${prefix}prefix <prefix>§f - Change the prefix for commands. Max is two characters.`,
        ...
        `§6${prefix}punish <username>§f - ${config.customcommands.punish ? `Removes all items from player's inventory and ender chest.` : textDisabled}`,
        `§6${prefix}tpa <username>§f - ${config.customcommands.tpa ? `Teleport to a player or vice versa.` : textDisabled}`,
        `§6${prefix}despawn <entityName>:all§f - ${config.customcommands.despawn ? `Despawns all or specified entities if they exist.` : textDisabled}`,
        ` `,
        ...
        `§6${prefix}give <username> <item> <amount>§f - ${config.customcommands.give ? `Gives player items.` : textDisabled}`,
        `§6${prefix}ecwipe <username>§f - ${config.customcommands.ecwipe ? `Clears a players ender chest.` : textDisabled}`,
        `§6${prefix}fly <username>§f - ${config.customcommands.fly ? `Toggles fly mode in survival.` : textDisabled}`,
        `§6${prefix}freeze <username>§f - ${config.customcommands.freeze ? `Freeze a player and make it so they cant move.` : textDisabled}`,
        `§6${prefix}stats <username>§f - ${config.customcommands.stats ? `View a specific players anticheat logs.` : textDisabled}`,
        ...
        `§6${prefix}invsee <username>§f - ${config.customcommands.invsee ? `Lists all the items in the usernames inventory.` : textDisabled}`,
        `§6${prefix}sethome <name>§f - ${config.customcommands.sethome ? `Saves current coordinates as home.` : textDisabled}`,
        `§6${prefix}gohome <name>§f - ${config.customcommands.gohome ? `Teleport back to saved home coordinates.` : textDisabled}`,
        `§6${prefix}listhome§f - ${config.customcommands.listhome ? `Shows your list of saved locations.` : textDisabled}`,
        `§6${prefix}delhome <name>§f - ${config.customcommands.delhome ? `Deletes a saved location from list.` : textDisabled}`,
        `§6${prefix}hotbar <optional>§f - ${config.customcommands.hotbar ? `Toggles hotbar message for all players. Optional: Message` : textDisabled}`,
