import { world, Player, ItemStack, Items, MinecraftEnchantmentTypes, Enchantment, BeforeItemUseOnEvent, EntityInventoryComponent, ItemEnchantsComponent, system } from "@minecraft/server";
...
async function illegalitemsb(object: BeforeItemUseOnEvent) {
    system.run(() => {
        ...
        if (antiShulkerBoolean && item.typeId in shulkerItems) {
            ...
            invContainer.container.setItem(hand, undefined);
